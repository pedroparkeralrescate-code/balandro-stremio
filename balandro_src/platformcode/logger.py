...
# Convertir explícitamente a int (el mock de Kodi puede retornar string)
try:
    loglevel = int(config.get_setting('debug', 0))
except (ValueError, TypeError):
    loglevel = 0  # 0 (error), 1 (error+info), 2 (error+info+debug)
